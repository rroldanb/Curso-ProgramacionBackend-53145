...
class ProductsController{
    ...
    getProducts = async (req, res) => {
        ...
        try {
            ...
            await this.productsService.getProducts(findParams);
    ...
    createProduct = async (req, res) => {
        try {
          ...
          const lastProductId = await this.productsService.addProduct(nuevoProducto);
    ...
    updateProduct = async (req, res) => {
        ...
        try {
          ...
          if (!!updatedFields.code){
           let existeCode = await this.productsService.validaCode(updatedFields.code);
            if (existeCode) {
              console.log(
          ...
          let product = await this.productsService.getProductById(pid);
          ...
          await this.productsService.updateProduct(pid, updatedProduct);
