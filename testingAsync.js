...
const testingAsync = async () => {
    ...
    console.log("Test 05.- Lista los productos (aparece solo el ingresado la primera vez):");
    console.log(await productManager.getProducts());
    ...
    console.log("Test 15.- Despliega el producto 4 y luego lo modifica intentando pasar una propiedad que no existe");
    console.log(await productManager.getProductById(4));

    await productManager.updateProduct(4, {
        title: "producto 4 modificado",
        description: "Este es el producto modificado 4, precio, thumbinal y code no se modifican",
        stock: 4444,
